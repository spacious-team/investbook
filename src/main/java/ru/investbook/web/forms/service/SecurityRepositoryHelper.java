...
public class SecurityRepositoryHelper {
     ...
     */
    private int saveAndFlush(@Nullable Integer securityId, @Nullable String isin, String securityName, SecurityType securityType) {
    ...
    private int saveAndFlush(@Nullable String isin, String securityName, SecurityType securityType) {
    ...
    private int saveAndFlush(SecurityEntity security, @Nullable String isin, @Nullable String securityName,
