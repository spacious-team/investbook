...
@Component
public class SberCashAndSecurityReportTablesFactory implements ReportTablesFactory {

    @Override
    public boolean canCreate(BrokerReport brokerReport) {
        return brokerReport instanceof SberCashAndSecurityBrokerReportAdapter;
    }

    @Override
    public ReportTables create(BrokerReport brokerReport) {
        return new SberCashAndSecurityReportTables((SberCashAndSecurityBrokerReportAdapter) brokerReport);
    }
}
