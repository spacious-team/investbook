...
или воспользуйтесь [формами](src/main/asciidoc/investbook-forms.adoc) ввода информации уже на вашей версии приложения.
...
рядом с вами в установленном приложении внизу на главной странице ссылка "Документация".
