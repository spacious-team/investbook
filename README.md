...
[![spring-boot-version](https://img.shields.io/badge/spring--boot-3.5.7-brightgreen?style=flat-square)](https://github.com/spring-projects/spring-boot/releases)
...
1. [Открытый код](#почему-код-приложения-открыт) - дополнительная гарантия безопасности и уверенности
   в доступности данных только вам.
...
напишите [нам](https://t.me/+IzYUY5hyvZtmOTIy). Также вы можете внести свои сделки (и другую информацию)
в [excel файл](src/main/asciidoc/investbook-input-format.adoc) (брокер в этом случае не имеет значения) и загрузить его
в приложение для анализа. Формат файла прост и состоит из минимального набора информации, пример

| Событие | Дата       | Бумага | Количество | Цена | Комиссия | Валюта |
|---------|------------|--------|------------|------|----------|--------|
| Покупка | 14.07.2025 | SBER   | 10         | 300  | 1,5      | RUB    |

Либо можно внести сделки (и другую информацию) через [web интерфейс](src/main/asciidoc/investbook-forms.adoc).
Также поддержку вашего брокера могут предложить сторонние разработчики через функционал расширений.
Инструкция для установки расширений доступна для операционных систем [windows](docs/install-on-windows.md),
...
### Документация
Дополнительная информация может быть найдена в [документации](docs/documentation.md), также офлайн документация всегда
...
Также существует функционал [расширений](docs/developer-guide-extension.md), который позволяет сторонним разработчикам
