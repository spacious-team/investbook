...
В ближайшей перспективе появится функциональность расширений, которые позволят сторонним разработчикам писать свои парсеры
отчетов для любых брокеров. Эти расширения могут быть подключены к приложению Investbook пользователями по желанию.
