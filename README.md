...
Лицензия, под которой распространяется приложение, означает, что оно передано обществу. Вне зависимости от решения
других разработчиков версия приложения на этом сайте всегда будет распространяться бесплатно.
Но лицензия также дает возможность любому разработчику улучшать собственную копию приложения в том числе с целью ее
[продажи](https://www.gnu.org/licenses/gpl-faq.ru.html#DoesTheGPLAllowMoney) (с оговоркой, что доработанный исходный
код будет открыт в сети интернет).
