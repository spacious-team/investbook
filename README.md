...
- [Лицензия](#лицензия)
- [Как помочь развивать продукт](#как-помочь-развивать-продукт)
...
### Как помочь развивать продукт
... или развивать его самостоятельно с целью получения финансового вознаграждения.

Приветствуется любая улучшающая доработка. Лицензия, под которой выпущен код приложения, означает, что оно передано
обществу. Вне зависимости от решения других разработчиков эта версия приложения и его исходный код всегда будут
распространяться бесплатно. Но если вы частный разработчик, вы можете улучшать собственную копию этого приложения с целью
ее продажи третьим лицам, лицензия это не запрещает (с оговоркой, что доработанный исходный код всегда должен быть
открыт в сети, будет оставаться достоянием общества и не будет распространяться под названием `Investbook`).

В ближайшей перспективе появится функциональность расширений, которые позволят сторонним разработчикам писать свои
парсеры отчетов брокера. Эти расширения могут быть подключены к приложению Investbook конечного пользователя по его желанию.
Разработчики расширений могут их распространять как бесплатно, так и на платной основе. Поэтому, разработчики,
преследуя даже разные цели - финансовые или как команда "Spacious Team" гуманистические, - могут работать сообща.

Какие бы цели вы не преследовали, возможна улучшение кода как в текущем репозитории, так и в своем собственном,
скопировав имеющийся код и дорабатывая его в одиночку или своей группой единомышленников. Если вы решили улучшать
приложение в этом репозитории, ознакомьтесь, пожалуйста, со следующей [информацией](docs/CONTRIBUTING.md).
