...
со счета средств, историю ввода и вывода денежных средств, итоговую доходность инвестиций и спекуляций с момента
открытия счета, будущие удержания налогов брокером и ваши налоговые обязательства, - это не полный перечень информации,
которую рассчитывает приложение.

Некоторые брокеры предоставляют личный кабинет и графики, но вполне могут не раскрывать всей информации. Если у вас несколько
...
![main-page](https://user-images.githubusercontent.com/11336712/108728545-c21a7980-753a-11eb-87e6-0ab01d8d2859.png)
...
### Брокеры
Приложение анализирует отчеты брокеров Промсвязьбанк (xlsx, xml), Уралсиб (zip с xls) и ВТБ (xls). В ближайшее время
будет поддерживать Финам и Тинькофф. Если ваш счет открыт у другого брокера, напишите [нам](https://t.me/investbook_support)
или воспользуйтесь [формами](src/main/asciidoc/investbook-forms.adoc) ввода информации. Также поддержку вашего брокера
могут предложить сторонние разработчики через функционал расширений. Инструкция для установки расширений доступна
для операционных систем [windows](docs/install-on-windows.md), [mac](docs/install-on-linux.md) и
[linux](docs/install-on-linux.md).
